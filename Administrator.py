...
def run_app():
    ...
    # Add buttons to the sidebar with flat appearance
    btn=tk.Button(sidebar_content_frame, text="Home", width=17, height=2, relief='flat', bg='#f0f0f0', font=('Helvetica', 12), command=lambda: print("")).pack(fill='x', pady=(5, 0))
    btn=tk.Button(sidebar_content_frame, text="Dashboard", width=17, height=2, relief='flat', bg='#f0f0f0', font=('Helvetica', 12), command=lambda: print("")).pack(fill='x', pady=(5, 0))
    btn=tk.Button(sidebar_content_frame, text="Inventory", width=17, height=2, relief='flat', bg='#f0f0f0', font=('Helvetica', 12), command=lambda: print("")).pack(fill='x', pady=(5, 0))
    btn=tk.Button(sidebar_content_frame, text="Items", width=17, height=2, relief='flat', bg='#f0f0f0', font=('Helvetica', 12), command=lambda: print("")).pack(fill='x', pady=(5, 0))
    btn=tk.Button(sidebar_content_frame, text="Profiles", width=17, height=2, relief='flat', bg='#f0f0f0', font=('Helvetica', 12), command=lambda: print("")).pack(fill='x', pady=(5, 0))
    btn=tk.Button(sidebar_content_frame, text="Supplier", width=17, height=2, relief='flat', bg='#f0f0f0', font=('Helvetica', 12), command=lambda: print("")).pack(fill='x', pady=(5, 0))
    ...
    frame_treeview = tk.Frame(content_frame)
